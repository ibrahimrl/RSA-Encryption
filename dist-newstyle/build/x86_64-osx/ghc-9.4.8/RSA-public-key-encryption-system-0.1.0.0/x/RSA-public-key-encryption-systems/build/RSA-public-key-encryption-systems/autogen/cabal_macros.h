...
/* package RSA-public-key-encryption-system-0.1.0.0 */
#ifndef VERSION_RSA_public_key_encryption_system
#define VERSION_RSA_public_key_encryption_system "0.1.0.0"
#endif /* VERSION_RSA_public_key_encryption_system */
#ifndef MIN_VERSION_RSA_public_key_encryption_system
#define MIN_VERSION_RSA_public_key_encryption_system(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_RSA_public_key_encryption_system */
...
#define CURRENT_COMPONENT_ID "RSA-public-key-encryption-system-0.1.0.0-inplace-RSA-public-key-encryption-systems"
